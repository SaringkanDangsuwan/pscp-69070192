...
```text
โจทย์ให้รับค่า rgb 2 สี แล้วให้หาสีใหม่ที่ได้จาก 2 สีนี้
Input:
โปรแกรมรับค่า rgb 2 สี แต่ลละสีประกอบด้วย 3 ค่า คือ r g b
Output:
ค่าสีใหม่ที่ได้จากการผสมสีของทั้งสองสี
Constraints:
ค่าสีมีได้ตั้งแต่ 0-255
```
...
```text
Step 1: อ่านค่าสีแต่ละสี
Step 2: ทำการหาค่าสีใหม่ โดยนำค่าสีแต่ละอันของทั้งสองสี มาหาค่าเฉลี่ย
Step 3: แสดงผลค่าสีใหม่ที่ได้มา
```
...
```text
เหมือนกับแผนแรก โดยรับค่าสีแต่ละตัวจะเก็บเป็น list และนำค่า r g b มาหาค่าเฉลี่ยโดยการหาร // แล้วจึงแสดงผล
```
...
```text
ทดสอบการทำงานปกติของโปรแกรม ในการหาค่าเฉลี่ย
```
...
```text
ทดสอบกรณีสีมีค่าเป็น 0 ทั้งสอง
```
...
```text
ทดสอบเมื่อค่านึงเป็น 0 อีกค่านึงมีค่าสูงสุด
```
