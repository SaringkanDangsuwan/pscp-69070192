...
```text
โจทย์ตรวจสอบสระภาษาอังกฤษในค่าอินพุต
Input: 
คำภาษาอังกฤษ
...
```text
Step 1: รับข้อความและเปลี่ยนตัวอักษรทั้งหมดให้เป็นตัวพิมพ์เล็ก
Step 2: สร้างสระภาษาอังกฤษ
Step 3: สร้างลิสต์สำหรับเก็บจำนวนของสระแต่ละตัว โดยกำหนดค่าเริ่มต้นเป็น 0
Step 4: ตรวจสอบตัวอักษรทุกตัวในข้อความทีละตัว
Step 5: ถ้าตัวอักษรนั้นเป็นสระ ให้หาตำแหน่งของสระในลิสต์ แล้วเพิ่มจำนวนของสระตัวนั้นขึ้น 1
Step 6: ตรวจสอบจำนวนของสระแต่ละตัว
Step 7: ถ้าสระตัวใดมีจำนวนมากกว่า 0 ให้แสดงชื่อสระและจำนวนที่นับได้
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยรับข้อความมาเปลี่ยนเป็นตัวพิมพ์เล็ก แล้ววนตรวจตัวอักษรทีละตัว ถ้าพบว่าเป็นสระ จะเพิ่มค่าจำนวนของสระนั้น จากนั้นแสดงเฉพาะสระที่พบในข้อความพร้อมจำนวนที่นับได้
```
...
```text
ตรวจสอบว่าโปรแกรมไม่นับแยกระหว่างตัวพิมพ์ใหญ่กับตัวพิมพ์เล็ก
```
