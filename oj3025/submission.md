...
```text
โจทย์ให้กรอกวันและเดือน

Input:
บรรทัดแรก รับค่าเดือนเป็นจำนวนเต็ม
บรรทัดสอง รับค่าวันเป็นจำนวนเต็ม

Output:
โปรแกรมควรแสดงฤดู มี 4 ฤดู winter spring summer fall

โดยฤดูจะตัดทุกๆ วันวันที่ 21 เดือนที่หาร 3 ลงตัว
```
...
```text
Step 1: อ่านวันและเดือน
Step 2: ตรวจว่าเดือนหาร 3 ลงตัวหรือไม่
Step 3: ถ้าหาร 3 ลงตัว ให้ดูว่าวันที่มากหรือน้อยกว่า 21
Step 4: ถ้าน้อยกว่า 21 ให้พิมพ์ฤดูกาลเดิม
Step 5: ถ้าตั้งแต่ 21 เป็นต้นไป ให้พิมพ์ฤดูกาลใหม่
Step 6: กรณีที่เหลือที่เดือนหาร 3 ไม่ลงตัว
Step 7: ถ้าอยู่ระหว่างเดือน 1-3 พิมพ์ winter เดือน 4-6 พิมพ์ spring เดือน 7-9 พิมพ์ summer เดือน 10-12 พิมพ์ fall
```
...
```text
วิธีแรกพอเขียนมาเป็นโค้ด เงื่อนไขค่อนข้างเยอะ ไม่ค่อยครอบคลุม จึงแบ่งเงื่อนไขฤดูให้มันครอบคลุม ไม่ซอยย่อยเหมือนที่ส่งแรกๆ ทำให้พบเจอเงื่อนไขที่ขาดหายไป
```
...
```text
เพื่อดูในกรณี spring โดยไม่สนวันที่
```
...
```text
เพื่อดูกรณี spring โดยสนวันที่ เพราะเดือน 6 มีการเปลี่ยนฤดู
```
...
```text
เพื่อดูกรณี summer เดือนที่ 6 เปลี่ยนจาก spring ไป summer
```
