...
```text
หาค่าในช่วง a b  ที่หาร d และเหลือเศษ r
...
```text
Step 1: รับจำนวนเต็ม a, b, d และ r
Step 2: กำหนดตัวแปรสำหรับนับจำนวนคำตอบเริ่มต้นเป็น 0
Step 3: ลูปตรวจสอบจำนวนเต็มทุกค่าตั้งแต่ a ถึง b
Step 4: นำแต่ละจำนวนไปหารด้วย d แล้วตรวจสอบว่าเหลือเศษเท่ากับ r หรือไม่
Step 5: ถ้าเหลือเศษเท่ากับ r ให้เพิ่มตัวนับขึ้น 1
Step 6: เมื่อวนครบทุกจำนวนแล้ว ให้แสดงค่าของตัวเลข
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยใช้ลูปตรวจสอบตัวเลขทุกจำนวนตั้งแต่ a ถึง b แล้วใช้ modulo ดูว่าเมื่อนำแต่ละจำนวนไปหารด้วย d จะเหลือเศษเท่ากับ r หรือไม่ ถ้าตรงตามเงื่อนไขก็เพิ่มตัวนับขึ้น 1 และเมื่อจบลูปจึงแสดงจำนวนทั้งหมดที่พบ
```
