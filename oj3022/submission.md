...
```text
โจทย์ให้แปลงค่าอุณหภูมิในแต่ละหน่วย มี C F K R

Input:
บรรทัดแรก ค่าอุณหภูมิเลขทศนิยม
บรรทัดสอง หน่วยของอุณหภูมิเดิม
บรรทัดสาม หน่วยของอุณหภูมิใหม่

Output:
โปรแกรมจะให้แปลงอุณหภูมิ ตามสูตรการแปลงอุณหภูมิ
```
...
```text
Step 1: อ่านค่าอุณหภูมิ หน่วยเดิมและหน่วยใหม่
Step 2: ตรวจว่าอุณหภูมิเดิมคืออะไรและต้องการแปลงเป็นอุณหภูมิใหม่อะไร
Step 3: เข้าสูตรการแปลงอุณหภูมิที่ต้องการ
Step 4: แสดงผลอุณหภูมิใหม่
```
...
```text
วิธีสุดท้ายเหมือนกับวิธีแรก ใช้เงื่อนไขตรวจดูอุณหภูมิเดิมและใหม่จากค่าอินพุต จากนั้นก็ไล่ดูเงื่อนไขแต่ละอย่าง เช่น จาก C เป็น F หรือ F เป็น K เป็นต้น จากนั้นจึงเข้าสูตรในการคำนวณ
```
...
```text
เพื่อเช็คเงื่อนไขเมื่อหน่วยเหมือนกัน โปรแกรมต้องแสดงอุณหภูมิเดิมออกมา
```
