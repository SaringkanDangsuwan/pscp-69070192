...
```text
หาว่าตั้งแต่ค่า n จนถึง 0 มีค่าไหนที่หาร 10 ได้ลงตัวบ้าง
```
...
```text
Step 1: อ่านค่า number
Step 2: ใช้ลูปนับถอยหลังจาก number จนถึง 0
Step 3: ตรวจสอบว่าแต่ละจำนวนหารด้วย 10 ลงตัวหรือไม่
Step 4: ถ้าหารลงตัว ให้แสดงจำนวนนั้นออกมาในบรรทัดเดียวกัน
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก โดยใช้ for loop นับถอยหลังจาก number จนถึง 0 แล้วใช้ modulo ตรวจว่าแต่ละค่าหารด้วย 10 ลงตัวหรือไม่ ถ้าหารลงตัวจึงพิมพ์ค่านั้นออกมา โดยใช้ end=" " เพื่อให้ผลลัพธ์อยู่ในบรรทัดเดียวกัน
```
...
```text
เป็นเคสปกติ เช็คการทำงานโดยรวม
```
...
```text
ตรวจสอบการทำงานกรณีอินพุตเป็น 0
```
...
```text
ตรวจสอบการทำงานกรณี input หาร 0 ไม่ลงตัว
```
