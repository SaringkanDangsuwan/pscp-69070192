...
```text
โจทย์ต้องการให้ฉันแปลงชื่อย่อของไพ่เป็นชื่อเต็ม

Input:
โปรแกรมรับค่าตัวชื่อย่อของไพ่ แบ่งเป็นสองกลุ่ม ซ้ายคือค่าไพ่ ขวาคือกลุ่มไพ่

Output:
โปรแกรมแสดงผลชื่อเต็มๆ ของไพ่
...
```text
Step 1: อ่านค่าไพ่และกลุ่มไพ่
Step 2: ตรวจดูว่าค่าไพ่และกลุ่มไพ่ตรงกับชื่อเต็มตัวไหน
Step 3: กำหนดค่าไพ่และกลุ่มไพ่ใหม่ให้เป็นชื่อเต็ม
Step 4: แสดงผลค่าไพ่และกลุ่มไพ่เต็มๆ
```
...
```text
วิธีสุดท้ายเหมือนกับวิธีแรก ฉันใช้เงื่อนไขในการตรวจสอบค่าไพ่และกลุ่มไพ่ว่าตรงกับอันไหน
```
...
```text
เช็คเมื่อพิมพ์ตัวอักษร lower และเลข 2 หลัก
```
...
```text
เช็ค input เมื่อ upper and lower ผสมกัน
```
