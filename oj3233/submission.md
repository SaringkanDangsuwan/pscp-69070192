...
```text
โจทย์ให้ฉันเทียบรางวัลลอตเตอรี่สองค่าว่าตรงกับรางวัลใดๆ บ้าง

Input:
บรรทัด 1 ลอตเตอรี่ที่ถูกรางวัล
บรรทัด 2 ลอตเตอรี่ที่ซื้อ

Output:
เงินรางวัลที่ได้รับจากลอตเตอรี่

Constraints:
ลอตเตอรี่ประกอบด้วยตัวอักษรคั่นด้วยวรรคและเลข 5 หลัก
ประเภทรางวัลแบ่งเป็น
เลขและอักษรตรง ได้ 1000000
เลขตรงอย่างเดียว ได้ 100000
เลขท้าย 3 ตัว อักษรตรง ได้ 2000
เลขท้าย 2 ตัว อักษรตรง ได้ 1000
เลขท้าย 3 ตัว อักษรไม่ตรง ได้ 200
เลขท้าย 2 ตัว อักษรไม่ตรง ได้ 100
อักษรตรง เลขไม่ตรง ได้ 20
ไม่มีอะไรตรง ได้ 0
และต้องได้รางวัลสูงสุดรางวัลเดียว
```
...
```text
Step 1: รับตัวอักษรและหมายเลขที่ถูกรางวัล
Step 2: รับตัวอักษรและหมายเลขของฉัน
Step 3: ตรวจสอบว่าตัวอักษรและเลขทั้งหมดตรงหรือไม่ หากตรง PRIZE = 1000000
Step 4: หากเลขตรง แต่อักษรไม่ตรง PRIZE = 100000
Step 5: อักษรตรง ตรวจเลขท้าย 3 ตัว และ 2 ตัว ตามลำดับ หากตรง PRIZE = 2000, 1000 ตามลำดับ
Step 6: อักษรไม่ตรง ตรวจเลขท้าย 3 ตัว และ 2 ตัว ตามลำดับ หากตรง PRIZE = 200, 100 ตามลำดับ
Step 7: เลขไม่ตรง แต่อักษรตรง PRIZE = 20
Step 8: ไม่ตรงเลย PRIZE = 0
Step 9: แสดงรางวัลที่ได้
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก โดยใช้ if-elif ตรวจเงื่อนไขจากรางวัลสูงที่สุดไปต่ำที่สุด และใช้ slicing เพื่อตรวจเลขท้าย 3, 2 ตัว
```
...
```text
เช็คกรณีอักษรตรงและเลขท้าย 2 ตัว
```
...
```text
เช็คในกรณีอักษรไม่ตรงแต่เลขตรง
```
...
```text
เช็คกรณีเลขท้าย 3 ตัว อักษรไม่ตรง
```
