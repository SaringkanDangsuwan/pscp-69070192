...
```text
โจทย์ให้กรอกคะแนนรวมและคะแนนสูงสุด และหากคะแนนต่างกันมาก มีโอกาส Surprise
Input:
บรรทัดแรก คะแนนรวม
บรรทัดสอง คะแนนสูงสุด
```
...
```text
Step 1: รับค่าผลรวมของตัวเลขทั้งสามเก็บไว้ใน total
Step 2: รับค่าตัวเลขที่มากที่สุดเก็บไว้ใน highest
Step 3: คำนวณค่าตัวเลขที่น้อยที่สุด
Step 4: หาผลต่างระหว่าง highest และ lowest
Step 5: หากผลต่างมากกว่า 2  แสดง Surprising
Step 6: หากผลต่างไม่เกิน 2 แสดง Not surprising
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก โดยคำนวณค่าต่ำสุดที่เป็นไปได้จากผลรวมและค่าสูงสุด แล้วตรวจสอบผลต่างระหว่างค่าสูงสุดกับค่าต่ำสุด หากผลต่างมากกว่า 2 จะแสดงว่าเป็น Surprising นอกจากนั้นจะแสดงว่าเป็น Not surprising
```
...
```text
ทดสอบกรณีค่าสูงสุดกับต่ำสุดต่างกันมากกว่า 2 และทดสอบการกำหนดค่าต่ำสุดไม่ให้ต่ำกว่า 0
```
...
```text
ใช้ทดสอบค่าที่ใกล้เงื่อนไขที่คะแนนมากกว่า 2
```
...
```text
ใช้ทดสอบค่าที่ทำให้ not surprising
```
