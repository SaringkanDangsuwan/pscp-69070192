...
```text
โจทย์ให้รับ string 5 บรรทัด แล้วให้ทำกรอบสี่เหลี่ยมล้อมรอบ strings
Input:
โปรแกรมรับค่า string 5 บรรทัด
Output:
แสดงผลออกมา 7 บรรทัดโดยจะมี space คั่นซ้ายขวา
Constraints:
space ที่ต่อท้ายคำใน input จะไม่ถูกนับเป็นข้อความ
```
...
```text
Step 1: หาจำนวนคำที่ยาวที่สุดใน input เพื่อมาทำเป็นกรอบบนและล่าง
Step 2: ทำการพิมพ์ค่าแต่ละบรรทัด โดยมีกรอบซ้ายและขวาหุ้ม
Step 3: กรอบซ้ายและข้อความจะต้องมี space คั่นกลาง ส่วนขอบขวาต้องเรียงเสมอกันกับกรอบช่องสุดท้ายของกรอบบนและล่าง โดยได้มาจากนำค่ามากที่สุดของคำมาลบกับค่าบรรทัดนั้น
```
...
```text
เหมือนกับแผนแรก โดยใช้ max ควบกับ for loop หาค่าของคำที่มากที่สุด และใช้ for loop ในการแสดงผล
```
...
```text
ดูกรณีที่มีบรรทัดว่าง เพื่อเช็คว่าโปรแกรมจะทำงานได้ตรงตามที่ต้องการไหม
```
...
```text
ตรวจสอบกรณีที่มีความยาวแต่ละบรรทัดเท่ากัน
```
...
```text
ตรวจสอบการทำงานโดยรวมของโปรแกรม
```
